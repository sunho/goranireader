          ...
          <IonRow>
            ...
            <IonCard>
              ...
              <IonCardContent>
                <IonList>
                  <IonItem>
                    <IonInput value={word} onIonChange={e => {setWord(e.detail.value!)}} placeholder="First Word"></IonInput>
                  </IonItem>
                  <IonItem>
                    <IonInput value={word2} onIonChange={e => {setWord2(e.detail.value!)}} placeholder="Second Word"></IonInput>
                  </IonItem>
                  <IonItem>
                    <IonInput value={number_} onIonChange={e => {setNumber_(e.detail.value!)}} placeholder="Number"></IonInput>
                  </IonItem>
                </IonList>
