...
open class FolioReaderConfig: NSObject {
    ...
    open var barTintColor = UIColor(rgba: "#6ACC50")
    ...
    open var localizedReaderOnePageLeft = NSLocalizedString("한장 남음", comment: "")
    open var localizedReaderManyPagesLeft = NSLocalizedString("장 남음", comment: "")
