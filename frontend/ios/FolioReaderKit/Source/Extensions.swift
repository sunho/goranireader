...
internal extension UIImage {
    ...
    func ignoreSystemTint(color: UIColor) -> UIImage? {
        return self.imageTintColor(color)?.withRenderingMode(.alwaysOriginal)
    }
...
internal extension UIViewController {
    ...
    func setTranslucentNavigation(_ translucent: Bool = true, color: UIColor, tintColor: UIColor = UIColor.white, titleColor: UIColor = UIColor.white, andFont font: UIFont = UIFont.systemFont(ofSize: 17)) {
        let navBar = self.navigationController?.navigationBar
