...
func (p *ProgressQuiz) Register(d *dim.Group) {
	d.GET("", p.List)
...
func (p *ProgressQuiz) List(c2 echo.Context) error {
	c := c2.(*models.Context)
	var out []dbmodels.QuizProgress
...
func (p *ProgressQuiz) Put(c2 echo.Context) error {
	c := c2.(*models.Context)
	var pro dbmodels.QuizProgress
...
func (p *ProgressQuiz) Delete(c2 echo.Context) error {
	c := c2.(*models.Context)
